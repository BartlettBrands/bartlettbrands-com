...
(function($) {
    $.browser = {};
    $.browser.msie = /msie|trident/i.test(navigator.userAgent.toLowerCase());
    ...
    var $background = $("<img />").addClass("vegas-background"), $overlay = $("<div />").addClass("vegas-overlay"), $loading = $("<div />").addClass("vegas-loading"), $current = $(), paused = null, backgrounds = [], step = 0, delay = 5e3, walk = function() {}, timer, methods = {
        init: function(settings) {
            ...
            $new.css({
                ...
                if ($current.is("img")) {
                    $current.stop();
                    $new.hide().insertAfter($current).show().addClass('active');
                    $this = this;
                    setTimeout( function( ) {
                        $(".vegas-background:first-child").remove();
                        $("body").trigger("vegascomplete", [ $this, step - 1 ]);
                        options.complete.apply($new, [ step - 1 ]);
                    }, 2000 );
                } else {
                    $new.hide().prependTo("body").show().addClass('active');
                    $this = this;
                    setTimeout( function( ) {
                        $("body").trigger("vegascomplete", [ $this, step - 1 ]);
