<div id="vp-pfui-format-quote-fields" style="display: none;">
	...
	<div class="vp-pfui-elm-block">
		<label for="vp-pfui-format-quote-source-name"><?php _e('Quote Content', 'vp-post-formats-ui'); ?></label>
	...
	<div class="vp-pfui-elm-block">
		<label for="vp-pfui-format-quote-source-url"><?php _e('Quote Author', 'vp-post-formats-ui'); ?></label>
