...
class penci_popular_news_widget extends WP_Widget {
	 ...
	 * Widget setup.
	 */
	function penci_popular_news_widget() {
		/* Widget settings. */
	...
	function form( $instance ) {
		...
		$defaults = array( 'title' => esc_html__('Popular Posts', 'soledad'), 'number' => 5, 'categories' => '', 'featured' => false, 'allfeatured' => false, 'thumbright' => false, 'postdate' => false );
